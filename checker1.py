...
@file-format: each proxy one line like '127.0.0.1:3128'
"""
...
def check_proxy(proxy):
    try:
        ...
        # opener.open("https://www.twitter.com")
        opener.open("http://www.porn-plus.com")
...
if SAVE_ALIVE:
    SAVE_ALIVE_PROXY_F = open("alives", "a")
